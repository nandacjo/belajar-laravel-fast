...
## Belajar Laravel Jalur Cepat

Membuat migration:
Berikut cara membuat migration di larvel:
Buka temrminal di project larvel anda
Lalu ketikkan perintah

php artisan make:migration create_siswas

Lalu tekan enter
Pastikan anda sudah membuat database yang anda gunakan

## Cara mengisi colum di migration

Cara mengisi column di database migration
Buka folder database lalu pilih migration
